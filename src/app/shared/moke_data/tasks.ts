export const tasks = [
    {
        ...
        boardId: "IK_TODO",
        description: "Please collect the Cash memos for the Grocery.",
        name: "Admin assigned task to Mr. Prakash",
    ...
    },
    {
        ...
        description: "Please collect the Packaging material for the Grocery.",
        name: "Admin assigned task to Mr. Joy",
    ...
    },
    {
        ...
        boardId: "IK_TODO",
        description: "Please send emails and collect the Cash memos for the 3rd party IT services.",
